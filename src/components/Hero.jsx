  ...
  return (
    ...
    >
      ...
      <div className="container-x relative z-10">
        ...
        >
          <span className="eyebrow justify-center">miRNA Therapeutics</span>
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold tracking-[-0.02em] leading-[1.05] text-neoves-black dark:text-white mt-5">
            ...
            through miRNA-based therapeutics.
          </h1>
          ...
          <p className="mt-8 text-base sm:text-lg text-neoves-black/80 dark:text-white/80 max-w-2xl mx-auto leading-relaxed">
            ...
            quality of life. Neoves researches innovative miRNA-based therapeutic approaches,
            grounded in network pharmacology, to restore function and improve well-being.
          </p>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6">
            {["Mercatus Center", "3FVC", "AJVC"].map((b) => (
              <div
                key={b}
