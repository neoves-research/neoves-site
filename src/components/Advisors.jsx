...
const advisors = [
  ...
  },
  {
    ...
    link: "https://www.3f.vc/",
  },
  {
    name: "AJVC",
    sub: "Backers · 2026",
    logo: "/assets/ajvc-logo.png",
    link: "https://www.ajuniorvc.com/",
  },
  {
    name: "BITS Hyderabad",
    sub: "Startup Ecosystem · TBI",
    logo: "/assets/bits-logo.png",
    link: "https://tbi.bits-hyderabad.ac.in/",
  },
];
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {advisors.map((a, i) => (
          <motion.a
            ...
            className="block rounded-2xl bg-white dark:bg-neutral-800 border border-black/8 dark:border-white/10 p-7 hover:border-neoves-blue/35 transition-colors"
          >
            <img
              src={a.logo}
              alt={a.name}
