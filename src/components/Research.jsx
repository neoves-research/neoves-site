...
const goals = [
  { icon: Dna, text: "Map disease-driving gene networks underlying neuropathy at the systems level." },
  { icon: FlaskConical, text: "Identify microRNA targets for nerve repair with network pharmacology." },
      ...
      <div className="container-x relative z-10">
        <div className="max-w-3xl">
          ...
          <h2 className="heading-lg mt-5 text-neoves-black dark:text-white">
            Exploring the therapeutic potential of microRNA for neuropathy and nerve regeneration.
          </h2>
          {/* Body text – slightly bigger */}
          <p className="mt-6 text-neoves-black/80 dark:text-white/80 leading-relaxed text-lg">
            Neoves researches microRNA-based therapeutic strategies for neuropathy and nerve
            regeneration using network pharmacology — mapping disease-associated gene networks to
            identify microRNA targets, connecting basic science with patient-centred outcomes.
          </p>
        </div>
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-10 h-full flex flex-col justify-end text-white">
              ...
              <h3 className="font-display text-2xl md:text-3xl font-semibold tracking-tight mt-3">
                microRNA as a lever for regenerating peripheral nerves.
              </h3>
            </div>
          </motion.div>
