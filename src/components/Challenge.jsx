...
import { AlertCircle, Activity, HeartPulse, Droplet } from "lucide-react";
...
const facts = [
  ...
  },
  {
    icon: Droplet,
    stat: "~50%",
    label: "of diabetic patients develop Diabetic Peripheral Neuropathy (DPN).",
  },
  {
    icon: Activity,
    stat: "Symptomatic",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <p className="mt-6 text-neoves-black/80 dark:text-white/80 leading-relaxed text-lg">
              Diabetes, cancer, and neurological diseases often lead to neuropathy, resulting
